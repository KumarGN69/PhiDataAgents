...
def do_search():
    custom_rag = CustomRAG(website=WEBSITE, search_str=SEARCH_STRING, prompt=SEARCH_PROMPT)
...
def generate_knowledge_graph():
    custom_rag = CustomRAG(website=WEBSITE, search_str=SEARCH_STRING, prompt=GRAPH_EXTRACT_PROMPT)
